...
When working in these areas, read the corresponding skill files for framework best practices:
- Auth: `.agents/skills/better-auth-best-practices/SKILL.md`
- Observability/tracing: `.agents/skills/langfuse-observability/SKILL.md`
- Browser automation: `.agents/skills/agent-browser/SKILL.md`
